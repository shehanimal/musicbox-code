...
<html lang="en">
	<head>
		...
		<title>Musicbox - Add Event</title>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					<h2 class="page-header">NEW EVENT INFORMATION</h2>
					...
					<div class="row placeholders">
						<div class="col-xs-12 col-sm-12	">
							<form class="form-horizontal form-alignment">
								...
								<h4 class="page-subheader">GENARAL INFORMATION </h4>
								<div class="row placeholder panel-section">
								<div class="col-sm-12">
									
									<div class="form-group">
										<?php    print drupal_render($form['field_event_general_info']); ?>
											</div>
								</div></div>
								...
								<div class=" col-sm-6">
									...
									<div class=" col-sm-6">
									<h4 class="page-subheader">EVENT POSTER</h4>
										<div class="form-group">
											<?php  print drupal_render($form['field_event_poster_image']); ?>
										</div>
									</div>
								...
								<div class="row placeholder  panel-section">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
										<div class="form-group">
										<?php  print drupal_render($form['field_time_of_event']); ?>
										</div>
									</div>
									</div>
