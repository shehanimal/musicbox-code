...
<html lang="en">
	<head>
		...
		<title>Musicbox - Add Songs</title>
...
$file = file_load($image_fid);
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h2 class="page-header">ADD NEW SONG</h2>
						...
						<div class="col-xs-12 col-sm-12	">
							<form class="form-horizontal form-alignment">
								...
								<div class="row placeholder panel-section">
									...
									<div class="col-sm-6">
										...
										<div class="form-group">
											<?php print drupal_render($form['field_song_title']);?>
									...
									<div class="col-sm-6">
										<div class="form-group" >
											...
											<?php print drupal_render($form['field_song_artist']);?>
										</div>
									</div>
								...
								<div class="row placeholder  panel-section">
									...
									<div class="col-sm-6">
									<h4 class="page-subheader">MOOD</h4>
										<div class="form-group">
											<?php print drupal_render($form['field_song_mood']);?>
										</div>
									</div>
									...
									<h4 class="page-subheader">SONG</h4>
										<div class="form-group">
												<?php print drupal_render($form['field_song_upload']);?>
										</div>
									</div>
									...
									<?php print drupal_render($form['field_music_video']);?>
										</div>
									...
									<div class="col-sm-12">
										...
										<div class="custom-file">
							<?php print drupal_render($form['field_song_image']);?>
										</div>
