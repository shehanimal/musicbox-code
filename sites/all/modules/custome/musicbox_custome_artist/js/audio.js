...
var Audio = {
	...
	info:{
		...
		load:function(id,album,artist,title,albumart,mp3){
			...
			$('.current-info .song-album').html('<i class="glyphicon glyphicon-music"></i> '+album);
			$('.current-info .song-title').html('<i class="glyphicon glyphicon-headphones"></i> '+title);
			$('.current-info .song-artist').html('<i class="glyphicon glyphicon-user"></i> '+artist);
			if(mp3)
